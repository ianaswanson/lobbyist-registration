  ...
  return (
    <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <Alert className="mb-6 border-blue-200 bg-blue-50">
        ...
        <AlertTitle className="text-blue-800">About Contract Exceptions</AlertTitle>
        <AlertDescription className="text-blue-700">
          <p className="mb-2">
            Multnomah County ordinance §9.230(C) prohibits the County from contracting with former
            officials who influenced contract authorization during or within 1 year after County service.
          </p>
          <p>
            The County Chair may grant exceptions with written findings showing either: (1) best interests
            of the County favor the contract, or (2) the person's influence was minimal. All exceptions
      ...
      <Card>
        <CardHeader>
          ...
          <CardDescription>
            {exceptions.length} exception{exceptions.length !== 1 ? "s" : ""} granted and publicly posted
          </CardDescription>
        </CardHeader>
        <CardContent>
          {exceptions.length === 0 ? (
                ...
                {exceptions.map((exception) => (
                  <TableRow key={exception.id}>
                    ...
                    <TableCell className="max-w-md">
                      <div className="line-clamp-2">{exception.contractDescription}</div>
                    </TableCell>
                    ...
                    <TableCell className="text-sm">
                      {exception.publiclyPostedDate
                        ? new Date(exception.publiclyPostedDate).toLocaleDateString()
                        : "N/A"}
                    </TableCell>
      ...
      <Card className="mt-6">
        ...
        <CardContent className="space-y-4">
          <p className="text-sm text-muted-foreground">
            If you are a former County official seeking to contract with the County within the 1-year
            cooling-off period, you must request an exception through the County Chair.
          </p>

          <div className="space-y-2">
            <h4 className="text-sm font-semibold">Requirements for Exception:</h4>
            <ul className="text-sm text-muted-foreground space-y-1 list-disc list-inside">
              <li>Written request explaining the circumstances</li>
              <li>
                Demonstration that either: (a) the contract serves the County's best interests, or (b)
                your influence on the contract was minimal
              </li>
          ...
          <Alert>
            ...
            <AlertDescription>
              To request an exception, contact the Office of the County Chair at:{" "}
              <a
          ...
          {selectedException && (
            <div className="space-y-4">
              <div>
                ...
                <p className="font-medium text-lg">{selectedException.formerOfficialName}</p>
              </div>
              ...
              <div>
                <Label className="text-muted-foreground">Justification & Findings</Label>
                <div className="mt-1 p-4 bg-gray-50 rounded-md border">
                  <p className="whitespace-pre-wrap">{selectedException.justification}</p>
                </div>
              </div>
              ...
              <div className="grid gap-4 md:grid-cols-2">
                <div>
                  ...
                  <p className="text-sm text-muted-foreground">County Chair</p>
                </div>
              ...
              <Alert className="border-blue-200 bg-blue-50">
                ...
                <AlertDescription className="text-blue-700">
                  This exception has been publicly posted in compliance with §9.230(C) of the
