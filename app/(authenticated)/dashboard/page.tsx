        ...
        <div className="mb-8">
          ...
          <p className="mt-2 text-gray-600">
            {session.user?.role === "LOBBYIST" &&
              "Manage your lobbyist registration and quarterly expense reports."}
            {session.user?.role === "EMPLOYER" &&
              "Track and report your organization's lobbying expenditures."}
            {session.user?.role === "BOARD_MEMBER" &&
              "Post your calendar and lobbying receipts for public transparency."}
            {session.user?.role === "ADMIN" &&
              "Monitor compliance, review registrations, and manage the system."}
            {session.user?.role === "PUBLIC" &&
              "Search and view public lobbying records."}
          </p>
        </div>
        ...
        <div className="rounded-lg border bg-white p-6 shadow-sm">
          ...
          <div className="space-y-3 text-sm text-gray-600">
            <div>
              ...
              <p>
                Contact the Multnomah County Lobbying Registration Office for
                assistance.
              </p>
            </div>
            <div>
