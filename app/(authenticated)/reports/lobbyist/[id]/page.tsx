      ...
      <main className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
        ...
        <div className="grid grid-cols-1 gap-5 sm:grid-cols-3 mb-6">
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <dt className="text-sm font-medium text-gray-500 truncate">Total Food & Entertainment</dt>
              <dd className="mt-1 text-3xl font-semibold text-gray-900">{formatCurrency(report.totalFoodEntertainment)}</dd>
            </div>
          </div>
          <div className="bg-white overflow-hidden shadow rounded-lg">
            <div className="px-4 py-5 sm:p-6">
              <dt className="text-sm font-medium text-gray-500 truncate">Number of Expenses</dt>
              <dd className="mt-1 text-3xl font-semibold text-gray-900">{report.lineItems.length}</dd>
        ...
        <div className="bg-white shadow rounded-lg mb-6">
          ...
          <div className="px-4 py-5 sm:p-6">
            {report.lineItems.length === 0 ? (
              <p className="text-sm text-gray-500 text-center py-4">No expenses reported</p>
            ) : (
        ...
        <div className="bg-blue-50 border border-blue-200 shadow rounded-lg p-6">
          <div className="flex justify-between items-center">
            <div>
              <h3 className="text-lg font-medium text-blue-900">Total Food & Entertainment Spend</h3>
              <p className="text-sm text-blue-700 mt-1">All itemized expenses over $50</p>
            </div>
