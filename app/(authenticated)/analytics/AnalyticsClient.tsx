    ...
    <div className="container mx-auto max-w-7xl py-8">
      <div className="mb-8">
        ...
        <p className="text-muted-foreground">
          Public transparency dashboard showing lobbying spending trends and
          statistics
        </p>
      </div>
      ...
      <div className="mb-8 grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        ...
        <Card>
          ...
          <CardContent>
            ...
            <p className="text-muted-foreground text-xs">Total employers</p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <div className="text-2xl font-bold">
              {formatCurrency(
                data.summary.totalSpending / data.summary.reportCount || 0
              )}
            </div>
            <p className="text-muted-foreground text-xs">
          ...
          {data.quarterlyTrends.length === 0 ? (
            ...
            <div className="space-y-4">
              {data.quarterlyTrends.map((quarter) => {
                const percentage =
                  (quarter.totalSpending / maxQuarterlySpending) * 100;
                return (
                  <div
                  ...
                  >
                    ...
                    <div className="text-muted-foreground flex justify-between text-xs">
                      <span>
                        Lobbyist: {formatCurrency(quarter.lobbyistSpending)}
                      </span>
                      <span>
                        Employer: {formatCurrency(quarter.employerSpending)}
                      </span>
                    </div>
                  </div>
                );
          ...
          <div className="space-y-4">
            <div>
              ...
              <div className="h-6 w-full overflow-hidden rounded-full bg-gray-200">
                ...
                >
                  {(
                    (data.summary.totalLobbyistSpending /
            ...
            <div>
              ...
              <div className="h-6 w-full overflow-hidden rounded-full bg-gray-200">
                ...
                >
                  {(
                    (data.summary.totalEmployerSpending /
                      data.summary.totalSpending) *
                    100
                  ).toFixed(1)}
                  %
