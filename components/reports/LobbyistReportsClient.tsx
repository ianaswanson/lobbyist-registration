...
import { LobbyistExpenseReport, ExpenseLineItem, ReportStatus } from "@prisma/client"
...
export function LobbyistReportsClient({ reports: initialReports }: LobbyistReportsClientProps) {
