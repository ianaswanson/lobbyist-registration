...
test.describe('Demo Features', () => {
  test.describe('Demo Files Panel', () => {
    ...
    test('should show demo files panel on board calendar page', async ({ page }) => {
    ...
    test('should download demo CSV file', async ({ page }) => {
      ...
      const downloadLink = page.locator('a[download*="board-calendar-sample.csv"]');
      await expect(downloadLink).toBeVisible();

      // Verify href points to correct file
      await expect(downloadLink).toHaveAttribute('href', '/demo-files/board-calendar-sample.csv');
    });
  });
  ...
  test.describe('Demo Files on Lobbyist Expenses', () => {
    ...
    test('should show demo files panel on lobbyist expenses page', async ({ page }) => {
  ...
  test.describe('Demo Files on Employer Expenses', () => {
    ...
    test('should show demo files panel on employer expenses page', async ({ page }) => {
  ...
  test.describe('Demo Guide Button', () => {
    test('should display demo guide button on sign-in page', async ({ page }) => {
      await page.goto('/auth/signin');
    ...
    test('should display demo guide button on authenticated pages', async ({ page }) => {
      // Sign in
      await page.goto('/auth/signin');
