...
async function main() {
  ...
  console.log(
    "   ✓ Lobbyist user created: john.doe@lobbying.com / lobbyist123"
  );
  ...
  console.log(
    "   ✓ Lobbyist user created: jane.smith@advocacy.com / lobbyist123"
  );
  ...
  console.log(
    "   ✓ Board member created: commissioner@multnomah.gov / board123"
  );
  ...
  console.log(
    "   ✓ Board member created: commissioner.chen@multnomah.gov / board123"
  );
  ...
  console.log(
    "   ✓ Employer user created: contact@greenenergy.org / employer123"
  );
  ...
  const pendingEmployer = await prisma.employer.create({
    data: {
      ...
      businessDescription:
        "Non-profit focused on affordable housing and homelessness services",
    },
  });
  ...
  await prisma.lobbyistEmployer.create({
    data: {
      ...
      subjectsOfInterest:
        "Housing policy, homelessness services, affordable housing",
    },
  });
  ...
  await prisma.boardCalendarEntry.createMany({
    data: [
      // Commissioner Williams - Q1
      {
        ...
        participantsList:
          "County staff, TechCorp representatives, Public attendees",
        quarter: Quarter.Q1,
        year: 2025,
      },
      {
        ...
        participantsList:
          "IT Department heads, TechCorp lobbyist, Cybersecurity consultants",
        quarter: Quarter.Q1,
        year: 2025,
      },
      // Commissioner Williams - Q2
      {
        ...
        participantsList:
          "Finance Director, Budget Committee, Community advocates",
        quarter: Quarter.Q2,
        year: 2025,
      },
      {
        ...
        participantsList:
          "Transit agency staff, Environmental groups, Construction lobbyists",
        quarter: Quarter.Q2,
        year: 2025,
      },
      // Commissioner Williams - Q3
      {
        ...
        participantsList:
          "Sheriff, Police Chief, Community organizations, Public attendees",
        quarter: Quarter.Q3,
        year: 2025,
      },
      {
        ...
        eventTime: "2:00 PM - 4:00 PM",
        participantsList:
          "Housing Bureau, Developers, Affordable housing advocates",
        quarter: Quarter.Q3,
        year: 2025,
      },
      // Commissioner Williams - Q4
      {
        ...
        participantsList:
          "Department heads, County Administrator, Finance team",
        quarter: Quarter.Q4,
        year: 2025,
      },
      ...
      // Commissioner Chen - Q1
      {
        ...
        participantsList:
          "Environmental groups, Industry representatives, DEQ staff",
        quarter: Quarter.Q1,
        year: 2025,
      },
      {
        ...
        eventTime: "10:00 AM - 12:00 PM",
        participantsList:
          "Hospital administrators, Health advocates, Insurance lobbyists",
        quarter: Quarter.Q1,
        year: 2025,
      },
      ...
      },
      {
        ...
        participantsList:
          "Parks department, Recreation groups, Conservation organizations",
        quarter: Quarter.Q2,
        year: 2025,
      },
      // Commissioner Chen - Q3
      {
        ...
        participantsList:
          "Environmental organizations, Energy companies, Climate scientists",
        quarter: Quarter.Q3,
        year: 2025,
      },
      {
        ...
        eventTime: "2:00 PM - 4:00 PM",
        participantsList:
          "Chamber of Commerce, Small business owners, Economic development staff",
        quarter: Quarter.Q3,
        year: 2025,
      },
      // Commissioner Chen - Q4
      {
        ...
        eventTime: "10:00 AM - 12:00 PM",
        participantsList:
          "Veterans Affairs staff, VA representatives, Veterans groups",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        participantsList:
          "Urban planners, Community leaders, Development corporations",
        quarter: Quarter.Q4,
        year: 2025,
      },
    ],
  ...
  console.log(
    "   ✓ Created board calendar entries (4 quarters, 2 commissioners)"
  );
  ...
  console.log(
    "   ✓ Created board lobbying receipts (4 quarters, 2 commissioners)"
  );
  ...
  const violation1 = await prisma.violation.create({
    data: {
      ...
      description:
        "Failed to register within 3 working days after exceeding 10 hours threshold. Registration was submitted 7 days after threshold was reached.",
      fineAmount: 250.0,
      status: "ISSUED",
  ...
  const violation2 = await prisma.violation.create({
    data: {
      ...
      description:
        "Q2 2025 expense report submitted 5 days after the July 15 deadline.",
      fineAmount: 150.0,
      status: "ISSUED",
  ...
  const violation3 = await prisma.violation.create({
    data: {
      ...
      description:
        "Authorization document from employer not provided within required timeframe.",
      fineAmount: 200.0,
      status: "APPEALED",
  ...
  const violation4 = await prisma.violation.create({
    data: {
      ...
      description:
        "Expense report contained inaccurate information regarding lobbying activities.",
      fineAmount: 500.0,
      status: "UPHELD",
  ...
  const violation5 = await prisma.violation.create({
    data: {
      ...
      violationType: "LATE_REPORT",
      description:
        "First-time late report submission. Educational letter sent instead of fine.",
      fineAmount: 0.0,
      status: "ISSUED",
...
The violation stands as issued. The fine must be paid within 30 days.`,
  ...
  const oldViolation = await prisma.violation.create({
    data: {
      ...
      description:
        "Q4 2024 expense report not received by January 15, 2025 deadline.",
      fineAmount: 300.0,
      status: "OVERTURNED",
    ...
    data: [
      {
        ...
        contractDescription:
          "IT consulting services for County database modernization project. Former Deputy IT Director (2020-2024) now works for TechCorp Inc.",
...
Based on these findings, the Chair concludes that granting this exception serves the County's best interests and does not violate the spirit of §9.230.`,
      ...
      },
      {
        ...
        contractDescription:
          "Urban planning consulting for the Transit-Oriented Development Zone project. Former Senior Planner (2018-2023).",
        justification: `Written findings per §9.230(C):
...
Based on these findings, the Chair concludes that Mr. Martinez's influence on contract authorization was minimal and granting this exception is appropriate.`,
      ...
      },
      {
        ...
        contractDescription:
          "Public health consulting services for maternal health outreach program. Former Health Department Program Manager (2021-2024).",
        justification: `Written findings per §9.230(C):
...
The Chair concludes that granting this exception serves the County's best interests and advances critical public health objectives.`,
  ...
  await prisma.hourLog.createMany({
    data: [
      // Lobbyist1 logs - showing progression toward 10-hour threshold
      {
        ...
        hours: 2.5,
        description:
          "Prepared briefing materials for county commissioners on IT modernization proposal",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 3.0,
        description:
          "Attended board meeting and provided testimony on broadband expansion",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 4.5,
        description:
          "Met with IT department staff to discuss procurement timeline and requirements",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 5.0,
        description:
          "Drafted policy recommendations and coordinated with county legal counsel",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 6.0,
        description:
          "Organized stakeholder roundtable with commissioners and technology vendors",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 4.5,
        description:
          "Follow-up meetings with budget committee on funding allocation",
        quarter: Quarter.Q4,
        year: 2025,
      },
      ...
      // Lobbyist2 logs - regular quarterly tracking
      {
        ...
        hours: 4.0,
        description:
          "Healthcare policy briefing with county health department leadership",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 5.5,
        description:
          "Testified at public hearing on Medicaid expansion and met with commissioners",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 3.5,
        description:
          "Research and preparation of mental health services white paper for board review",
        quarter: Quarter.Q4,
        year: 2025,
      },
      {
        ...
        hours: 5.0,
        description:
          "Coalition building meetings with healthcare stakeholders and county staff",
        quarter: Quarter.Q4,
        year: 2025,
      },
  ...
  console.log(
    "   ✓ Created hour logs (2 lobbyists, 10 entries, demonstrating 10-hour threshold)"
  );
